...
function BottlePage() {
    ...
    const [bottleType, setBottleType] = useState<"breastmilk" | "formula">("breastmilk");
    ...
    return (
        <div className="space-y-6">
            <div className="text-center">
                <h1 className="text-2xl font-bold text-foreground mb-2">🍼 Bottle Feed</h1>
                <p className="text-muted-foreground">Record bottle feeding for your twins</p>
            </div>
                ...
                <CardContent>
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div className="space-y-2">
                            ...
                            <Select value={selectedTwin} onValueChange={(value: "A" | "B") => setSelectedTwin(value)}>
                                <SelectTrigger>
                                    <SelectValue />
                                </SelectTrigger>
                                <SelectContent>
                                    <SelectItem value="A">
                                        <div className="flex items-center gap-2">
                                            <div className={`w-3 h-3 rounded-full ${getTwinColorClasses("A")}`} />
                                            {twinAName}
                                        </div>
                                    </SelectItem>
                                    <SelectItem value="B">
                                        <div className="flex items-center gap-2">
                                            <div className={`w-3 h-3 rounded-full ${getTwinColorClasses("B")}`} />
                                            {twinBName}
                                        </div>
                                    </SelectItem>
                                </SelectContent>
                        ...
                        <div className="space-y-2">
                            ...
                            <Select value={bottleType} onValueChange={(value: "breastmilk" | "formula") => setBottleType(value)}>
                                <SelectTrigger>
                                    <SelectValue />
                                </SelectTrigger>
                                <SelectContent>
